...
<head>
    <meta charset="utf-8">
    <title>TransEra - Contest page</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                <a href="index.html" class="navbar-brand mx-4 mb-3">
                    <h3 class="text-primary"></i>Contest</h3>
                </a>
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="{{ url('/contest') }}" class="nav-item nav-link active"><i class="fa fa-quote-right me-2"></i>Contact Us</a>
