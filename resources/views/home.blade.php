...
<head>
    <meta charset="utf-8">
    <title>Dashboard on TransEra Legend</title>
        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="" class="nav-item nav-link"><i class="fa fa-th me-2"></i>My Profile</a>
                    <a href="" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>My Reservation</a>
                    <a href="" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Contact Us</a>
                </div>
            </nav>
        </div>
        <!-- Sidebar End -->
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-secondary navbar-dark sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img class="rounded-circle me-lg-2" src="{{asset('img/logo5.png')}}" alt="" style="width: 40px; height: 40px;">
